...
/**
 * Реализация сервиса для операций, связанных с пользователем.
 *
 * <p>Этот сервис обрабатывает аутентификацию пользователя, управление паролями и извлечение и обновление данных пользователя.</p>
 *
 * @Service Отмечает этот класс как стереотип службы Spring.
 * @Slf4j Обеспечивает возможность логирования через Slf4j.
 * @RequiredArgsConstructor Аннотация Lombok для генерации конструктора с необходимыми окончательными полями.
 */
